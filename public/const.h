...
//#define FL_INATTACK				(1<<31)
//#define FL_INATTACK2			(1<<32)
#else
#define	FL_ONGROUND				(1<<0)	// At rest / on the ground
#define FL_DUCKING				(1<<1)	// Player flag -- Player is fully crouched
...
//#define FL_INATTACK				(1<<32)
//#define FL_INATTACK2			(1<<33)
#endif
...
//////////////////////////////////////////////////////OverCharged///////////////////////////////////////////////////////
	EF_LASER = 0x400,	// player laser pointer
	EF_M = 0x800,	// player SMG's MuzzleFlash
	EF_EGONDISSOLVELIGHT = 0x001000,  // player AR2's MuzzleFlash
	EF_ML = 0x002000,// player Laser's MuzzleFlash
	EF_FRAGSLIGHT = 0x004000,	// player DUAL PISTOLS LEFT SMG's MuzzleFlash
	EF_ML_LEFT = 0x008000,	// player DUAL PISTOLS LEFT Laser's MuzzleFlash
	EF_FRAGFLIGHT = 0x010000,	// player DUAL PISTOLS LEFT AR2's MuzzleFlash
	EF_IMM = 0x020000,	// player laser pointer
	EF_BATTERYLIGHT = 0x040000,	// player laser pointer
	EF_HEALTHLIGHT = 0x080000,
	EF_FRAGLIGHT = 0x100000
