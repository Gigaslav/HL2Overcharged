    ...
    ISpObjectToken **ppObjectToken)
{
	...
	const size_t ulLenVendorPreferred = wcslen(pszVendorPreferred); // no size_t        //    const ulLenVendorPreferred = wcslen(pszVendorPreferred);
...
public:
	...
	static long CoMemCopyWFEX(const WAVEFORMATEX * pSrc, WAVEFORMATEX ** ppCoMemWFEX) // missing long     //static CoMemCopyWFEX(const WAVEFORMATEX * pSrc, WAVEFORMATEX ** ppCoMemWFEX)
    {
