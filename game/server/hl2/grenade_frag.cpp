...
public:
	...
	void	BlipSound() {	EmitSound("Grenade.Blip"); 		CPASFilter filter(GetAbsOrigin());	te->DynamicLight(filter, 0.0, &GetAbsOrigin(), 255, 0, 0, 4.5, 30, 0.1, 1.1); }
	void	DelayThink();
