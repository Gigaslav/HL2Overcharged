...
public:
	...
	virtual void	UseAmmoCrate(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value);
...
private:
	...
	void		RandomZap(bool hardSound = false);

	/*bool		jfoundedPlayer;
	int			jcount;
	bool		jcanTakeOffTheGun;*/
