...
void CNPC_FloorTurret::Precache(void)
{
	...
	PrecacheParticleSystem("ar2_normal");
#ifdef HL2_EPISODIC
...
void CNPC_FloorTurret::MakeTracer(const Vector &vecTracerSrc, const trace_t &tr, int iTracerType)
{
#if 1
...
void CNPC_FloorTurret::Shoot(const Vector &vecSrc, const Vector &vecDirToEnemy, bool bStrict)
{
	...
	DoMuzzleFlash();
	//DoMuzzleFlashOVR(1, 6, 64, 128, 255, "ar2_normal");
}

void CNPC_FloorTurret::DoMuzzleFlash(void)
{
