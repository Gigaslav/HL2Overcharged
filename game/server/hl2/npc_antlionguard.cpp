...
protected:
	...
	virtual bool	CanBecomeServersideRagdoll();
...
bool CNPC_AntlionGuard::CanBecomeRagdoll(void)
{
	...
	//if (Q_strstr(STRING(gpGlobals->mapname), "ep1") || Q_strstr(STRING(gpGlobals->mapname), "ep1"))
		//return true;
...
bool CNPC_AntlionGuard::CanBecomeServersideRagdoll()
{
	return false;
}
//-----------------------------------------------------------------------------
