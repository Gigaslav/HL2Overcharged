...
{
	{ "item_ammo_pistol",			"Pistol",		SIZE_AMMO_PISTOL,		0.3f },
	{ "item_ammo_smg1",				"SMG1",			SIZE_AMMO_SMG1,			0.3f },
	{ "item_ammo_smg1_grenade",		"SMG1_Grenade", SIZE_AMMO_SMG1_GRENADE, 0.05f },
	{ "item_ammo_ar2",				"AR2",			SIZE_AMMO_AR2,			0.2f },
	{ "item_box_buckshot",			"Buckshot",		SIZE_AMMO_BUCKSHOT,		0.2f },
	{ "item_rpg_round",				"RPG_Round",	SIZE_AMMO_RPG_ROUND,	0.05f },
	{ "weapon_frag",				"Grenade",		1,						0.1f },
	{ "item_ammo_357",				"357",			SIZE_AMMO_357,			0.1f },
	{ "item_ammo_crossbow",			"XBowBolt",		SIZE_AMMO_CROSSBOW,		0.05f },
	{ "item_ammo_ar2_altfire",		"AR2AltFire",	SIZE_AMMO_AR2_ALTFIRE,	0.05f },
	{ "item_ammo_gauss",			"GaussEnergy",  SIZE_AMMO_GAUSS_BOX,	0.2f },
	{ "item_ammo_ak47",				"Ak47",			SIZE_AMMO_AK47,			0.3f },
	{ "item_ammo_m249",				"M249",			SIZE_AMMO_M249,			0.2f },
	{ "item_ammo_sniper",			"SniperRound",  SIZE_AMMO_SNIPER,		0.2f },
	{ "item_ammo_combine_sniper", "CombineSniperRound", SIZE_AMMO_COMBINE_SNIPER, 0.2f },
	{ "item_ammo_rifle",			"OICW",			SIZE_AMMO_RIFLE,		0.3f },
	{ "weapon_molotov",				"Molotov",		1,						0.1f },
	{ "item_ammo_uranium",			"Uranium",		SIZE_AMMO_GAUSS_BOX,	0.1f },
	{ "item_ammo_ion",				"LaserPistol",  SIZE_AMMO_IONRIFLE,		0.1f },
	{ "item_flare_round",			"FlareRound",	SIZE_AMMO_FLARE_BOX,	0.1f },
	{ "item_ammo_alyxgun",			"AlyxGun",		SIZE_AMMO_ALYXGUN,		0.2f },
	{ "item_ammo_hopmine",			"HopMine",		1,						0.05f },
	{ "item_ammo_slam",				"Slam",			1,						0.05f },
	{ "item_ammo_hopwire",			"HopWire",		1,						0.03f },
	{ "item_ammo_tripwire",			"Tripwire",		1,						0.05f },
	{ "item_ammo_extinguisher",		"Extinguisher", 100,					0.05f },
};
...
BEGIN_DATADESC( CItem_DynamicResupply )
	...
	DEFINE_KEYFIELD( m_flDesiredAmmo[10], FIELD_FLOAT, "DesiredAmmoGauss" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[11], FIELD_FLOAT, "DesiredAmmoAk47" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[12], FIELD_FLOAT, "DesiredAmmoM249" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[13], FIELD_FLOAT, "DesiredAmmoSniper" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[14], FIELD_FLOAT, "DesiredAmmoRifle" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[15], FIELD_FLOAT, "DesiredAmmoMolotov" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[16], FIELD_FLOAT, "DesiredAmmoUranium" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[17], FIELD_FLOAT, "DesiredAmmoIon" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[18], FIELD_FLOAT, "DesiredAmmoFlare" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[19], FIELD_FLOAT, "DesiredAmmoAlyxGun" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[20], FIELD_FLOAT, "DesiredAmmoHopMine" ),
	DEFINE_KEYFIELD( m_flDesiredAmmo[21], FIELD_FLOAT, "DesiredAmmoSlam"),
	DEFINE_KEYFIELD( m_flDesiredAmmo[22], FIELD_FLOAT, "DesiredAmmoHopWire"),
	DEFINE_KEYFIELD( m_flDesiredAmmo[23], FIELD_FLOAT, "DesiredAmmoTripWire"),
	DEFINE_KEYFIELD( m_flDesiredAmmo[24], FIELD_FLOAT, "DesiredAmmoExtinguisher"),
...
CItem_DynamicResupply::CItem_DynamicResupply( void )
{
	...
	m_flDesiredHealth[0] = 0.8f;	// Health
	m_flDesiredHealth[1] = 0.4f;	// Armor
	m_flDesiredAmmo[0] = 0.3f;	// Pistol
	m_flDesiredAmmo[1] = 0.3f;	// SMG1
	m_flDesiredAmmo[2] = 0.05f;	// SMG1 Grenade
	m_flDesiredAmmo[3] = 0.2f;	// AR2
	m_flDesiredAmmo[4] = 0.2f;	// Shotgun
	m_flDesiredAmmo[5] = 0.05f;	// RPG Round
	m_flDesiredAmmo[6] = 0.1f;	// Grenade
	m_flDesiredAmmo[7] = 0.1f;		// 357
	m_flDesiredAmmo[8] = 0.05f;		// Crossbow
	m_flDesiredAmmo[9] = 0.05f;		// AR2 alt-fire
	m_flDesiredAmmo[10] = 0.2f;		// Gauss
	m_flDesiredAmmo[11] = 0.3f;		// Ak47
	m_flDesiredAmmo[12] = 0.3f;		// M249
	m_flDesiredAmmo[13] = 0.2f;		// Sniper
	m_flDesiredAmmo[14] = 0.3f;		// Rifle
	m_flDesiredAmmo[15] = 0.1f;		// Molotov
	m_flDesiredAmmo[16] = 0.1f;		// Uranium
	m_flDesiredAmmo[17] = 0.1f;		// Ion
	m_flDesiredAmmo[18] = 0.1f;		// Flare
	m_flDesiredAmmo[19] = 0.2f;		// AlyxGun
	m_flDesiredAmmo[20] = 0.05f;		// HopMine
	m_flDesiredAmmo[21] = 0.05f;		// Slam
	m_flDesiredAmmo[22] = 0.05f;		// HopWire
	m_flDesiredAmmo[23] = 0.05f;		// TripWire
	m_flDesiredAmmo[24] = 0.05f;		// Extinguisher
}
...
void CItem_DynamicResupply::SpawnFullItem( CItem_DynamicResupply *pMaster, CBasePlayer *pPlayer, int iDebug )
{
	...
	for ( i = 0; i < NUM_AMMO_ITEMS; ++i )
	{
		if ( flChoice <= flRatio[i] )
		{
			...
			//DevMsg("g_DynamicResupplyAmmoItems[i].sEntityName: %s \n", g_DynamicResupplyAmmoItems[i].sEntityName);
			if ( iDebug )
			{
...
bool CItem_DynamicResupply::SpawnItemFromRatio( int nCount, DynamicResupplyItems_t *pItems, int iDebug, SpawnInfo_t *pSpawnInfo, Vector *pVecSpawnOrigin )
{
	...
	//DevMsg("pItems[iSelectedIndex].sEntityName: %s \n", pItems[iSelectedIndex].sEntityName);
