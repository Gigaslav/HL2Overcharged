...
#include "cbase.h" 
 ...
 ConVar sk_bigmomma_health_factor( "sk_bigmomma_health_factor", "1000" ); 
 ConVar sk_bigmomma_dmg_slash( "sk_bigmomma_dmg_slash", "15" ); 
 ...
 #define PRECACHE_SOUND_ARRAY( a ) \
	{ for (int i = 0; i < ARRAYSIZE( a ); i++ ) enginesound->PrecacheSound((char *) a [i]); } // Light Kill : Why it is removed ? now fixed.
 ...
 public: 
   ...
   //void TraceAttack( const CTakeDamageInfo &info, const Vector &vecDir, trace_t *ptr ); //Overcharged : FIX
 ...
 */ 
 ...
 { 
   "npc/gonarch/gon_step1.wav", 
   "npc/gonarch/gon_step2.wav", 
   "npc/gonarch/gon_step3.wav", 
 }; 
 ...
 { 
   ...
   BaseClass::TraceAttack(info, vecDir, ptr, pAccumulator);	// Overcharged fixed
 } 
 ...
 { 
   ...
   if ( pHurt ) 
   { 
   CTakeDamageInfo info( this, this, sk_bigmomma_dmg_slash.GetFloat() /*15*/, DMG_CLUB | DMG_SLASH ); // Light Kill : Use goddamn convar !
 ...
 { 
   ...
   /*break; 
   case 1: 
   EmitSound( "bullchicken/bc_spithit2.wav" ); 
   break; 
   } */
   ...
   UTIL_DecalTrace( &tr, "BeerSplash" ); //"Splash"
   } 
   else 
   { 
