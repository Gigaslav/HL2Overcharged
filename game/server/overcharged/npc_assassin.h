...
public:
	...
	int  TranslateSchedule( int scheduleType );	// L1ght 15 : Must search near enemy if exist
...
private:
	...
	bool		m_bBlinkState;
	bool		m_bHaveWeapons;		// L1ght 15 : Have weapons on spawn or not
	bool		m_bPistolFiring;	// L1ght 15 : Propper firing
	int			m_iPistolShots;		// L1ght 15: Pistols shots	 Shots count. if > 5 start jump
	int			m_iSkin;			// L1ght 15 : Alt skins
