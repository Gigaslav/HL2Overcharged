...
BEGIN_DATADESC(Cgrenade_strooper_bounce)

END_DATADESC()

LINK_ENTITY_TO_CLASS(grenade_bounce, Cgrenade_strooper_bounce);

unsigned int Cgrenade_strooper_bounce::PhysicsSolidMaskForEntity( void ) const
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void Cgrenade_strooper_bounce::Precache()
{
	BaseClass::Precache();
...
void Cgrenade_strooper_bounce::Explode( trace_t *pTrace, int bitsDamageType )
{
