...
void ClientModeShared::LevelInit( const char *newmap )
{
	...
	g_pBulletManagerShotgun = (C_BulletManagerShotgun *)CreateEntityByName("bullet_manager_shotgun");
	ClientEntityList().AddNonNetworkableEntity(g_pBulletManagerShotgun);
}
