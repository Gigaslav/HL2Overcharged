...
ConVar oc_global_lightning_shadow_resolution("oc_global_lightning_shadow_resolution", "2048");
ConVar oc_global_lightning_shadow_filter_size("oc_global_lightning_shadow_filter_size", "0.5", FCVAR_ARCHIVE);
ConVar oc_global_lightning_shadow_slope_scale_depth_bias("oc_global_lightning_shadow_slope_scale_depth_bias", "16.0");
ConVar oc_global_lightning_shadow_depth_bias("oc_global_lightning_shadow_depth_bias", "0.0005");
#ifdef MAPBASE
...
IMPLEMENT_CLIENTCLASS_DT(C_GlobalLight, DT_GlobalLight, CGlobalLight)
	...
	RecvPropInt(RECVINFO(m_iShadowQuality)),
#ifdef MAPBASE
...
void C_GlobalLight::ClientThink()
{
	...
	bool bSupressWorldLights = true;//false;
...
//		vPos = Vector( 0.0f, 0.0f, 500.0f );
		...
		state.m_NearZ = m_flNearZ;// 4.0f;
		state.m_FarZ = m_flSunDistance * 2.0f;
		state.m_fBrightnessScale = m_flBrightnessScale;//2.0f;
		state.m_bGlobalLight = true;

		state.m_flShadowMapResolution = oc_global_lightning_shadow_resolution.GetFloat();
		state.m_flShadowFilterSize = oc_global_lightning_shadow_filter_size.GetFloat();
		state.m_flShadowSlopeScaleDepthBias = oc_global_lightning_shadow_slope_scale_depth_bias.GetFloat();
		state.m_flShadowDepthBias = oc_global_lightning_shadow_depth_bias.GetFloat();

#ifdef MAPBASE
		//m_flOrthoSize = cvar->FindVar("oc_global_lightning_orthosize")->GetFloat();
		...
		state.m_nShadowQuality = m_iShadowQuality;//1; // Allow entity to affect shadow quality
