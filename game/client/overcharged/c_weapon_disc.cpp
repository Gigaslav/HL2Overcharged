...
CLIENTEFFECT_REGISTER_BEGIN( PrecacheEffectDisc )
...
class C_DiscProjectile : public C_BaseCombatCharacter
{
	DECLARE_CLASS( C_DiscProjectile, C_BaseCombatCharacter );
	DECLARE_CLIENTCLASS();
public:
	
	C_DiscProjectile( void );
...
private:
	...
	C_DiscProjectile( const C_DiscProjectile & ); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT( C_DiscProjectile, DT_DiscProjectile, CDiscProjectile )
END_RECV_TABLE()

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
C_DiscProjectile::C_DiscProjectile( void )
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_DiscProjectile::OnDataChanged( DataUpdateType_t updateType )
{
...
// Output : int
//-----------------------------------------------------------------------------
int C_DiscProjectile::DrawModel( int flags )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_DiscProjectile::ClientThink( void )
{
	m_bUpdated = false;
}
...
// Input  : &data - 
//-----------------------------------------------------------------------------
void CrosshairLoadCallbackDisc( const CEffectData &data )
{
...
DECLARE_CLIENT_EFFECT( "CrossbowLoad", CrosshairLoadCallbackDisc );