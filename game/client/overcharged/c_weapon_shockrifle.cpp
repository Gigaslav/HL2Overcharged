...
class C_ShockRifleProjectile : public C_BaseCombatCharacter
{
	DECLARE_CLASS( C_ShockRifleProjectile, C_BaseCombatCharacter );
	DECLARE_CLIENTCLASS();
public:
	
	C_ShockRifleProjectile( void );
...
private:
	...
	C_ShockRifleProjectile( const C_ShockRifleProjectile & ); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT( C_ShockRifleProjectile, DT_ShockRifleProjectile, CShockRifleProjectile )
END_RECV_TABLE()

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
C_ShockRifleProjectile::C_ShockRifleProjectile( void )
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_ShockRifleProjectile::OnDataChanged( DataUpdateType_t updateType )
{
...
// Output : int
//-----------------------------------------------------------------------------
int C_ShockRifleProjectile::DrawModel( int flags )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_ShockRifleProjectile::ClientThink( void )
{
	m_bUpdated = false;
}
