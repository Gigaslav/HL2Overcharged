...
ConVar cl_detail_multiplier("cl_detail_multiplier", "1", FCVAR_ARCHIVE, "extra details to create");

#define SPRITE_MULTIPLIER  ( cl_detail_multiplier.GetInt() )

ConVar cl_fastdetailsprites("cl_fastdetailsprites", "1", FCVAR_ARCHIVE, "whether to use new detail sprite system");
