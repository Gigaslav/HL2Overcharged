...
#define CL_EVENT_EJECTBRASS_FIRST_BARREL		6010	// Eject a brass shell from attachment eject2//OverCharged
#define CL_EVENT_EJECTBRASS_SECOND_BARREL		6011	// Eject a brass shell from attachment eject2//OverCharged
#define CL_EVENT_EJECTBRASS_MAG		6015	// Eject a brass shell from attachment 1
#define CL_EVENT_EJECTBRASS_MAG_NPC		6016	// Eject a brass shell from attachment 1 (NPC)
