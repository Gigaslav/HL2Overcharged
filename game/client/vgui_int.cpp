...
//#include "overcharged/vgui_advoptions.h"	// BriJee OVR: Advanced options menu
//#include "overcharged/OVR_NEWMenu/OptionsDialog.h"
...
//#include "OverCharged/OVR_Menu/IOverrideInterface.h"
//#include "OverCharged/OVR_Menu/Overrideui_RootPanel.h"
...
bool VGui_Startup( CreateInterfaceFn appSystemFactory )
{
	...
	VPANEL gameParent = enginevgui->GetPanel(PANEL_INGAMESCREENS);	// BriJee OVR: Main menu blog
	//htmlview->Create(gameParent);
	//AdvOptions->Create(gameParent);									// BriJee OVR : Advanced options menu

	//vgui::Panel *pParent = GetParent();
	pMPanel = new CMainPanel(gameParent, "OVR_Panel");
	//pMPanel->Activate();
	return true;
}
...
void VGui_Shutdown()
{
	...
	delete pMPanel;
	//htmlview->Destroy();	// BriJee OVR: Main menu blog
	//AdvOptions->Destroy();	// BriJee OVR : Advanced options menu
