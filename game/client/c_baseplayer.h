...
#include "c_cam_attachment.h"//OverCharged
#include "c_muzzleflash_laser.h"//OverCharged
...
#include "c_muzzleflash_laser_middle.h"//OverCharged
#include "c_scope_light.h"//OverCharged
#include "OverCharged/c_nv_light.h"
#include "lasereffect.h"//OverCharged
...
class CLaserEffect;//OverCharged
class C_MuzzleflashLaser;//OverCharged
class C_MuzzleflashEffect;//OverCharged
class C_Ar2_MuzzleflashEffect;//OverCharged
class C_Ar2_Middle_MuzzleflashEffect;//OverCharged
class C_MuzzleflashLaserM;//OverCharged
class C_ScopeLight;//OverCharged
class C_NVLight;//OverCharged
...
public:
	...
	void	UpdateNightvision(void);
	static ShadowHandle_t GetFlashlightHandle();

	virtual void    ClientThink();//OverCharged
	virtual void	UpdateMuzzleFlashLaser(void);//OverCharged
	virtual void	UpdateMuzzleFlashSMG(void);//OverCharged
	virtual void	UpdateMuzzleFlashAR2(void);//OverCharged
	virtual void	UpdateLaser(void);//OverCharged
	virtual void	UpdateScopeLight(void);//OverCharged
	virtual void	UpdateIronSightLight(void);//OverCharged
	...
	bool			IsInSelectionSlowMo() { return m_bIsInSelectionMode; }
	bool			IsSighted();// { DevMsg("Client: m_bIsSighted: %i \n", m_bIsSighted); return m_bIsSighted; }
...
public:
	...
	bool m_bIsRunning;
	//bool m_bIsSighted;
	bool m_bSlowMoIsEnabled;
	bool m_bNightvisionEnabled;
	bool m_bIsInSelectionMode;
	bool doBatteryEffect;
	bool doHealthEffect;
	bool doRechargeEffect;
	bool doHealthRegenEffect;
	bool doDmgShockEffect;
	bool doDmgBulletEffect;
	/*bool enableDlight = false;*/
	//void UserCmd_Nightvision(void);
	C_NVLight *pNVLight;
	...
	virtual void        CalcThirdPersonDeathView(Vector& eyeOrigin, QAngle& eyeAngles, float& fov);		// OVR: 3rd person camera attachment
	virtual void        CalcFirstPersonDeathView(Vector& eyeOrigin, QAngle& eyeAngles, float& fov);		// OVR: 1st person camera attachment
...
public:
	...
	int m_iBloodOverlayDetailFrame;
	float m_flNextBloodDryDisappear;
	...
	bool			AllowCamAttachment;
	bool			SpecialBodyDraw;
...
///////////////////////////////////////////OverCharged/////////////////////////////////////
	// Player laser pointer
	CLaserEffect *m_plaser;

	// Player Other Muzzle flash
	C_MuzzleflashLaser *m_ML;
	C_MuzzleflashLaser *Switcher;
...
private:
	...
	// Player LaserMiddle MuzzleFlash
	C_MuzzleflashLaserM *m_MLM;

	// Player Scope Light
	C_ScopeLight *m_ScopeLight;

	C_Cam_Attachment *m_pBobViewModel;
	Vector m_vecLastBob;
