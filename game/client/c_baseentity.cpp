...
{
	////////////////////////////////////////////////////////Подгрузка всех партиклей тут///////////////////////////////////
	PrecacheParticleSystem("weapon_muzzle_smoke");
	PrecacheParticleSystem("laser_pointer");
	PrecacheParticleSystem("laser_pointer_dot");
	...
	PrecacheParticleSystem("overheat_AR3");
	//PrecacheParticleSystem("c17_muzzle_flash");
	...
	////////////////////////Shell Exaust////////////////////////////
	//	PrecacheParticleSystem( "shell_trail" );
	PrecacheParticleSystem("shell_eject_smoke_flash");
	//	PrecacheParticleSystem( "shell_fx_main");
	//	PrecacheParticleSystem( "ExtinguisherJet");
	PrecacheParticleSystem("shell_exhaust_smoke");
	//	PrecacheParticleSystem( "weapon_muzzle_flash_sparks4");
	//	PrecacheParticleSystem( "slime_splash_01");
	////////////////////////////////////////////////////////////////

	////////////////////////MuzzleFlashes//////////////////////////////
	PrecacheParticleSystem("weapon_muzzle_flash_rifle_and_smg");
	PrecacheParticleSystem("ar2_muzzle_flash");
	PrecacheParticleSystem("weapon_muzzle_smoke2");

	///////////////////smg flashes////////////////////////////////
	PrecacheParticleSystem("pd2_muzzle_normal");
	//////////////////////////////////////////////////////////////
	///////////////////Particle Tracers and trails//////////////////////
	//	PrecacheParticleSystem( "gunfire_ar3_beam_warps");
	PrecacheParticleSystem("particle_tracer_smg");
	PrecacheParticleSystem("trail_test02");
	PrecacheParticleSystem("trail_test03");
	PrecacheParticleSystem("1trail");
	PrecacheParticleSystem("Weapon_Combine_Ion_Cannon");
	PrecacheParticleSystem("weapon_tracer_smg");
	PrecacheParticleSystem("weapon_tracer_ar2");
	///////////////////////////////////////////////////////////////////
	PrecacheParticleSystem("weapon_laser_sight");
	PrecacheParticleSystem("weapon_laser_sight_dot");
	PrecacheParticleSystem("weapon_laser_sight_dot_FP");

	///////////////////////////////////////LaserDot//////////////////////////////
	PrecacheParticleSystem("LaserDot");
	PrecacheParticleSystem("laserGlow");
	PrecacheParticleSystem("weapon_muzzle_flash_assaultrifle_glow");
	PrecacheMaterial("sprites/redglow1.vmt");
	PrecacheParticleSystem("striderbuster_attached_pulse_solid");
	/////////////////////////////////////////////////////////////////////////////
	...
	PrecacheParticleSystem("weapon_muzzle_flash_shotgun_FP");
	PrecacheParticleSystem("weapon_muzzle_flash_shotgun_FP_cheap");
	PrecacheParticleSystem("weapon_muzzle_flash_autoshotgun");
	PrecacheParticleSystem("weapon_muzzle_flash_autoshotgun_fallback");
	PrecacheParticleSystem("weapon_muzzle_flash_autoshotgun_FP_cheap");

	PrecacheParticleSystem("muzzle2");
	...
	//////////////////////////////////////////Sparks/////////////////////////////////////////////////
	PrecacheParticleSystem("weapon_muzzle_flash_sparks");
	PrecacheParticleSystem("weapon_muzzle_flash_sparks2");
	PrecacheParticleSystem("weapon_muzzle_flash_sparks3");
	PrecacheParticleSystem("weapon_muzzle_flash_sparks4");
	PrecacheParticleSystem("weapon_muzzle_flash_sparks5");
	PrecacheParticleSystem("weapon_muzzle_flash_sparks6");
	/////////////////////////////////////////////////////////////////////////////////////////////////

	PrecacheParticleSystem("weapon_pipebomb_fuse_glow_2");
	PrecacheParticleSystem("weapon_pipebomb_fuse_smoke");
	PrecacheParticleSystem("weapon_muzzle_flash_huntingrifle_main");
	...
	PrecacheParticleSystem("gunfire_ar3_beams");
	//PrecacheParticleSystem("c17_tracers");
...
{
	if (modelrender && m_ModelInstance == MODEL_INSTANCE_INVALID)
	{
...
void C_BaseEntity::CreateLightEffects( void )
{
	...
	if (IsEffectActive(EF_BATTERYLIGHT))
	{
		dl = effects->CL_AllocDlight(index);
		dl->origin = GetAbsOrigin();
		//dl->origin[2] += 16;
		...
		dl->color.g = 255;
		dl->color.b = 255;
		dl->color.exponent = 3.5;
		dl->radius = random->RandomFloat(20, 20);
		dl->die = gpGlobals->curtime + 0.005;
	}
	if (IsEffectActive(EF_HEALTHLIGHT))
	{
		dl = effects->CL_AllocDlight(index);
		dl->origin = GetAbsOrigin();
		//dl->origin[2] += 16;
	...
	if (IsEffectActive(EF_FRAGLIGHT))
	{
	...
	if (IsEffectActive(EF_FRAGSLIGHT))
	{
		dl = effects->CL_AllocDlight(index);
		dl->origin = GetAbsOrigin();
		//dl->origin[2] += 16;
		...
		dl->color.g = 0;
		dl->color.b = 255;
		dl->color.exponent = 6.5;
		dl->radius = random->RandomFloat(20, 20);
		dl->die = gpGlobals->curtime + 0.005;
	}
	if (IsEffectActive(EF_FRAGFLIGHT))
	{
		dl = effects->CL_AllocDlight(index);
		dl->origin = GetAbsOrigin();
		//dl->origin[2] += 16;
		...
		dl->color.g = 255;
		dl->color.b = 0;
		dl->color.exponent = 2.5;
		dl->radius = random->RandomFloat(20, 20);
		dl->die = gpGlobals->curtime + 0.005;
	}
	if (IsEffectActive(EF_EGONDISSOLVELIGHT))
	{
		dl = effects->CL_AllocDlight(index);
		dl->origin = GetAbsOrigin();
		dl->origin[2] += 16;
		...
		dl->color.b = 255;
		dl->color.exponent = 2.5;
		dl->radius = random->RandomFloat(50, 100);
		dl->die = gpGlobals->curtime + 0.005;
	}
}
								  ...
								  bool doTrace, trace_t& tr, int maxLODToDecal )
{
	...
	if (doTrace && (GetSolid() == SOLID_VPHYSICS) && !tr.startsolid && !tr.allsolid)
	{
		...
		//DispatchParticleEffect("blood_impact_red_01", up, vecAngles);
	}
	else
	{
