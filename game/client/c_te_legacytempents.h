...
public:
	...
	virtual void				MuzzleFlashSecondary(const char *name, int colR, int colG, int colB, int type, ClientEntityHandle_t hEntity, int attachmentIndex, bool firstPerson) = 0;
	virtual void				MuzzleFlash(const char *name, int colR, int colG, int colB, int type, ClientEntityHandle_t hEntity, int attachmentIndex, bool firstPerson) = 0;
	virtual void				MuzzleflashCreateWeaponLight(ClientEntityHandle_t hEntity) = 0;

	virtual void				UpdateMuzzlePosition(ClientEntityHandle_t hEntity, int attachmentIndex) = 0;
	virtual void				MuzzleFlash(const Vector &pos1, const QAngle &angles, int type, ClientEntityHandle_t hEntity, bool firstPerson, int attachmentIndex) = 0;
	virtual void				EjectBrass( const Vector& pos1, const QAngle& angles, const QAngle& gunAngles, int type ) = 0;

	virtual void				EjectBrass(const Vector& pos1, const QAngle& angles, const QAngle& gunAngles, int type, C_BaseCombatCharacter *pOwner) = 0;
	virtual void				EjectBrass(const Vector& pos1, const QAngle& angles, const QAngle& gunAngles, int type, C_BasePlayer *pPlayer) = 0;
	virtual void				EjectBrass(const Vector& pos1, const QAngle& angles, const QAngle& gunAngles, int type, C_BaseCombatWeapon *pWeapon) = 0;

	virtual void				EjectBrassMag(const Vector& pos1, const QAngle& angles, const QAngle& gunAngles, int type) = 0;//OverCharged
	virtual void				CreateSphere(const Vector& pos1, const QAngle& gunAngles, int type, C_BasePlayer *pPlayer) = 0;//OverCharged
	...
	virtual void					TracerCallBack(ClientEntityHandle_t hEntity, int attachmentIndex, const trace_t &tr, int trType) = 0;
	virtual void					MuzzleLightCallBack() = 0;
	virtual void					MuzzleFlash_Combine_NPC(ClientEntityHandle_t hEntity, int attachmentIndex) = 0;
	virtual void					MuzzleFlash_Combine_NPC_Particle_Effect(ClientEntityHandle_t hEntity, int attachmentIndex) = 0;
	virtual void							MuzzleFlash_AirboatGun_NPC_Particle_Effect(ClientEntityHandle_t hEntity, int attachmentIndex) = 0;
	virtual void					MuzzleFlash_APC_NPC_Particle_Effect(ClientEntityHandle_t hEntity, int attachmentIndex) = 0;
};
...
public:
	...
	virtual void			MuzzleFlashSecondary(const char *name, int colR, int colG, int colB, int type, ClientEntityHandle_t hEntity, int attachmentIndex, bool firstPerson);
	virtual void			MuzzleFlash(const char *name, int colR, int colG, int colB, int type, ClientEntityHandle_t hEntity, int attachmentIndex, bool firstPerson);
	virtual void				UpdateMuzzlePosition(ClientEntityHandle_t hEntity, int attachmentIndex);
	//TracersOrdinates		pStructOrdinates;
	virtual void			MuzzleFlash(const Vector &pos1, const QAngle &angles, int type, ClientEntityHandle_t hEntity, bool firstPerson = false, int attachmentIndex = 1);
	...
	virtual void			EjectBrass(const Vector& pos1, const QAngle& angles, const QAngle& gunAngles, int type, C_BaseCombatCharacter *pOwner);
	virtual void			EjectBrass(const Vector& pos1, const QAngle& angles, const QAngle& gunAngles, int type, C_BasePlayer *pPlayer);

	virtual void			EjectBrass(const Vector& pos1, const QAngle& angles, const QAngle& gunAngles, int type, C_BaseCombatWeapon *pWeapon);

	virtual void			EjectBrassMag(const Vector &pos1, const QAngle &angles, const QAngle &gunAngles, int type);//OverCharged
	virtual void			CreateSphere(const Vector &pos1, const QAngle &gunAngles, int type, C_BasePlayer *pPlayer);//OverCharged
	...
	virtual void			TracerCallBack(ClientEntityHandle_t hEntity, int attachmentIndex, const trace_t &tr, int trType);
	virtual void			MuzzleLightCallBack();
	void					MuzzleFlash_Combine_NPC(ClientEntityHandle_t hEntity, int attachmentIndex);
	void					MuzzleFlash_Combine_NPC_Particle_Effect(ClientEntityHandle_t hEntity, int attachmentIndex);
	void					MuzzleFlash_AirboatGun_NPC_Particle_Effect(ClientEntityHandle_t hEntity, int attachmentIndex);
	void					MuzzleFlash_APC_NPC_Particle_Effect(ClientEntityHandle_t hEntity, int attachmentIndex);
// Data
public:
	enum
	{ 
...
private:
	...
	struct model_t			*m_Mag[3];//OverCharged
...
private:
	...
	// AK47					
	void					MuzzleFlash_AK47_Player(ClientEntityHandle_t hEntity, int attachmentIndex);
	void					MuzzleFlash_AK47_NPC(ClientEntityHandle_t hEntity, int attachmentIndex);
	...
	//////////////////////////////////////////////////////////////////////OverCharged////////////////////////////////////////////////////////////////
	////Shell exhaust/////////
	void					Shell_exhaust(C_BasePlayer *pPlayer);
	void					Shell_exhaust(C_BaseCombatWeapon *pWeapon);
	void					Shell_exhaust_Npc(C_BaseCombatCharacter *pOwner);
	/*void					Shell_exhaust_0(void);
	void					Shell_exhaust_1(void);
	void					Shell_exhaust_2(void);
	void					Shell_exhaust_3(void);*/


	private:
	///////////Muzzle Flahes////////////////
	void					MuzzleFlash_General_Player_Particle_Effect(const char *name, int colR, int colG, int colB, ClientEntityHandle_t hEntity, int attachmentIndex);
	void					MuzzleFlash_General_NPC_Particle_Effect(const char *name, int colR, int colG, int colB, ClientEntityHandle_t hEntity, int attachmentIndex);

	void					MuzzleFlash_General_Player_Secondary_Particle_Effect(const char *name, int colR, int colG, int colB, ClientEntityHandle_t hEntity, int attachmentIndex);
	void					MuzzleFlash_General_NPC_Secondary_Particle_Effect(const char *name, int colR, int colG, int colB, ClientEntityHandle_t hEntity, int attachmentIndex);

	void					MuzzleflashCreatePlayerLight(ClientEntityHandle_t hEntity);
	void					MuzzleflashCreateNPCLight(ClientEntityHandle_t hEntity);
	void					MuzzleflashCreateWeaponLight(ClientEntityHandle_t hEntity);
};
