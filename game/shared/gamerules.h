...
// Damage rules for ammo types
	...
	virtual float GetAmmoDamageBullet(CBaseEntity *pAttacker, bool IsPlayer, int nAmmoType, CBaseEntity *pVictim);
...
// Setup
	...
	int GetGamemode;//OverCharged
	bool bHasRandomized;//OverCharged
	int iRandomGamemode;//OverCharged
