...
#define MAX_WEAPON_POSITIONS	30	// max number of items within a slot
#define MAX_ITEM_TYPES			6	// hud item selection slots
#define MAX_WEAPONS				256	// Max number of weapons available //128

#define MAX_ITEMS				5	// hard coded item types

#define WEAPON_NOCLIP			-1	// clip sizes set to this tell the weapon it doesn't use a clip
//BriJee: Overcharged max ammo slots
#define	MAX_AMMO_TYPES	64 //32		// ???
#define MAX_AMMO_SLOTS  64 //32		// not really slots
...
//  than two, sigh
#define MAX_VIEWMODELS			5//2

#define MAX_BEAM_ENTS			30
...
enum
{
	...
	MUZZLEFLASH_SHOTGUN,
	MUZZLEFLASH_SMG1,
	MUZZLEFLASH_SMG2,//OverCharged
	MUZZLEFLASH_AK47,//OverCharged
	MUZZLEFLASH_PISTOL,
	MUZZLEFLASH_COMBINE,
	MUZZLEFLASH_357,
	MUZZLEFLASH_RPG,
	MUZZLEFLASH_COMBINE_TURRET,
	MUZZLEFLASH_DUAL_FLASH,//OverCharged
	MUZZLEFLASH_RIFLE,//OverCharged
	MUZZLEFLASH_SNIPER,//OverCharged
	MUZZLEFLASH_GAUSS,//OverCharged
	MUZZLEFLASH_ABGUN,//OverCharged
	MUZZLEFLASH_SHOCK,//OverCharged
	MUZZLEFLASH_SPORE,//OverCharged
...
#define DMG_DISSOLVE_EGON		(1<<30)		// Dissolving!
#define DMG_DISSOLVE_EGON_ELECTRICAL		(1<<31)		// Dissolving!
#define DMG_GAUSS			(32)	// electric shock
...
struct FireBulletsInfo_t
{
	FireBulletsInfo_t()
	{
		...
		m_flLatency = 0.0f;
		m_bHoldedAttack = false;
	}

	FireBulletsInfo_t( int nShots, const Vector &vecSrc, const Vector &vecDir, const Vector &vecSpread, float flDistance, int nAmmoType, bool bPrimaryAttack = true , bool holdedAttack = false)
	{
		m_iShots = nShots;
		m_vecSrc = vecSrc;
...
enum FirefightPrimaryGamemodes
{
	...
	FIREFIGHT_PRIMARY_RESISTANCERETRIBUTION
};
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
