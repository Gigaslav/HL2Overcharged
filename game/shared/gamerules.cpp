...
void CGameRules::CreateStandardEntities()
{
	...
	//if (pBullet != NULL)
		//DevMsg("FOUNDEDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");

	//g_pBulletManager = (CBulletManager*)CBaseEntity::Create("bullet_manager", vec3_origin, vec3_angle);
	//pBullet = g_pBulletManager;
	//g_pBulletManagerShotgun = (CBulletManagerShotgun*)CBaseEntity::Create("bullet_manager_shotgun", vec3_origin, vec3_angle);
	//gEntList.AddNetworkableEntity(g_pBulletManager);
	//gEntList.AddNetworkableEntity(g_pBulletManagerShotgun);
}
...
float CGameRules::GetAmmoDamageBullet(CBaseEntity *pAttacker, bool IsPlayer, int nAmmoType, CBaseEntity *pVictim)
{
	float flDamage = 0;
	CAmmoDef *pAmmoDef = GetAmmoDef();
