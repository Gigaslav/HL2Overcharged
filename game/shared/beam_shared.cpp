...
void CBeam::RelinkBeam( void )
{
	...
	/*CPASFilter filter(vecBeamMin), filter2(vecBeamMax);
	te->DynamicLight(filter, 0.0, &vecBeamMin, 255, 95, 55, 8, 100, 0.1, 0);//OverCharged

	te->DynamicLight(filter2, 0.0, &vecBeamMax, 255, 95, 55, 8, 100, 0.1, 0);//OverCharged*/
